...
const PostPackage = () => {
    ...
    const onFinish = async (values) => {
        try {
            ...
            if (isUpdating && currentPackage) {
                ...
                response = await api.put(`/PostPackage/updatePackage/${currentPackage.id}`, requestBody);
            } else {
            ...
            if (response.status === 200) {
                message.success(isUpdating ? "Package updated successfully!" : "Package created successfully!");
                ...
                message.error(isUpdating ? "Failed to update package." : "Failed to create package.");
            }
        } catch (error) {
    ...
    const deletePackage = async (packageId) => {
        try {
            setLoading(true);
            const response = await api.delete(`PostPackage/deletePakage/${packageId}`);
