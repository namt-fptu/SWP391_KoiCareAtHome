    ...
    <div className="flex h-screen bg-gray-900 text-white p-8">
      ...
      <div className="w-full">
        ...
        <div className="mb-8">
          ...
          <div className="flex space-x-4">
            {['low', 'medium', 'high'].map(growth => (
              <button
                key={growth}
                className={`py-2 px-4 rounded ${selectedGrowth === growth ? 'bg-blue-500' : 'bg-gray-700'}`}
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-5 gap-4">
            {['6-8', '9-12', '13-16', '17-20', '21-28'].map(temp => (
              <button
                key={temp}
                className={`py-2 px-4 rounded ${selectedTemp === temp ? 'bg-blue-500' : 'bg-gray-700'}`}
        ...
        <div className="mt-8">
          ...
          <p>The recommended amount of food should be split evenly into 3-5 feedings per day. This way the koi will ingest the food better.</p>
        </div>
      </div>
    </div>
  );
